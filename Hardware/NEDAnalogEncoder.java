...
@Config
public class NEDAnalogEncoder implements HardwareDevice {
    ...
    public NEDAnalogEncoder(AnalogInput enc){
        this(enc, DEFAULT_RANGE);
    }
    public NEDAnalogEncoder(AnalogInput enc, double aRange){
        encoder = enc;
        analogRange = aRange;
        offset = 0;
        inverted = false;
    ...
    public NEDAnalogEncoder zero(double off){
        offset = off;
        return this;
    }
    public NEDAnalogEncoder setInverted(boolean invert){
        inverted = invert;
        return this;
    }

    public NEDAnalogEncoder setWraparound(boolean wraparound) {
